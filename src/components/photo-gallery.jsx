// source https://github.com/neptunian/react-photo-gallery
...
class Gallery extends React.Component {
  ...
  render() {
    ...
    if (remainder) {
      ...
      var lastRowWidth = Math.floor(
        this.state.containerWidth / cols * remainder -
          remainder * (this.props.margin * 2)
      );
    ...
    for (var i = 0; i < this.props.photos.length; i += cols) {
      ...
      for (var j = i; j < i + cols; j++) {
        ...
        this.props.photos[j].aspectRatio =
          this.props.photos[j].width / this.props.photos[j].height;
